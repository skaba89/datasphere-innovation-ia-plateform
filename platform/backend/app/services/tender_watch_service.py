...
def discover_tenders(query: str = "", limit: int = 20) -> list[dict]:
    ...
    This first implementation is intentionally deterministic and safe for local demos.
    Real connectors can later replace or enrich BASE_SOURCES without changing the API contract.
    """
